...
public class ConsumerDemo {
    ...
    /**
     * 订阅主题，这个地方只传了一个主题：ufo-test-topic1
     */
    public static final List<String> topicList = Arrays.asList("ufo-test-topic1");
    ...
    public static void main(String[] args)  throws Exception{
        ...
        //主机信息
        properties.put("bootstrap.servers", bootstrapServersAddr);
        //群组id
